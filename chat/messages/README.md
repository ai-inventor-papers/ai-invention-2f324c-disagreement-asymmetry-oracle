...
- **1. create_idea** — `hypo_loop`
  - round_1
    - `chat/messages/1_create_idea/round_1/1_gen_hypo.md` — 134 messages
    - `chat/messages/1_create_idea/round_1/2_review_hypo.md` — 91 messages
- **2. test_idea** — `invention_loop`
  - round_1
    ...
    - `2_gen_plan/` — 3 task(s)
      ...
      - `chat/messages/2_test_idea/round_1/2_gen_plan/gen_plan_research_1.md` — 112 messages
    - `3_gen_art/` — 3 task(s)
      - `chat/messages/2_test_idea/round_1/3_gen_art/gen_art_dataset_1.md` — 261 messages
      - `chat/messages/2_test_idea/round_1/3_gen_art/gen_art_experiment_1.md` — 467 messages
      - `chat/messages/2_test_idea/round_1/3_gen_art/gen_art_research_1.md` — 304 messages
    - `chat/messages/2_test_idea/round_1/4_gen_paper_text.md` — 241 messages
    - `chat/messages/2_test_idea/round_1/5_review_paper.md` — 108 messages
    - `chat/messages/2_test_idea/round_1/6_upd_hypo.md` — 17 messages
  - round_2
    - `chat/messages/2_test_idea/round_2/1_gen_strat.md` — 28 messages
    - `2_gen_plan/` — 1 task(s)
      - `chat/messages/2_test_idea/round_2/2_gen_plan/gen_plan_experiment_1.md` — 56 messages
    - `3_gen_art/` — 1 task(s)
      - `chat/messages/2_test_idea/round_2/3_gen_art/gen_art_experiment_1.md` — 310 messages
    - `chat/messages/2_test_idea/round_2/4_gen_paper_text.md` — 145 messages
    - `chat/messages/2_test_idea/round_2/5_review_paper.md` — 69 messages
    - `chat/messages/2_test_idea/round_2/6_upd_hypo.md` — 25 messages
- **3. report_results** — `gen_paper_repo`
  - `1_gen_viz/` — 4 task(s)
    - `chat/messages/3_report_results/1_gen_viz/gen_viz_1.md` — 64 messages
    - `chat/messages/3_report_results/1_gen_viz/gen_viz_2.md` — 70 messages
    - `chat/messages/3_report_results/1_gen_viz/gen_viz_3.md` — 56 messages
    - `chat/messages/3_report_results/1_gen_viz/gen_viz_4.md` — 88 messages
  - `2_gen_demo_art/` — 3 task(s)
    - `chat/messages/3_report_results/2_gen_demo_art/gen_demo_art_dataset_1.md` — 94 messages
    - `chat/messages/3_report_results/2_gen_demo_art/gen_demo_art_experiment_1.md` — 135 messages
    - `chat/messages/3_report_results/2_gen_demo_art/gen_demo_art_experiment_2.md` — 335 messages
  - `3_gen_full_paper/` — 2 task(s)
    - `chat/messages/3_report_results/3_gen_full_paper/gen_full_paper.md` — 197 messages
    - `chat/messages/3_report_results/3_gen_full_paper/gen_paper_site.md` — 190 messages
