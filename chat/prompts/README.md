...
- **2. test_idea** — `invention_loop`
  - round_1
    ...
    - `2_gen_plan/` — 3 task(s)
      ...
      - `chat/prompts/2_test_idea/round_1/2_gen_plan/gen_plan_research_1.md` — 18 prompts
    - `3_gen_art/` — 3 task(s)
      - `chat/prompts/2_test_idea/round_1/3_gen_art/gen_art_dataset_1.md` — 13 prompts
      - `chat/prompts/2_test_idea/round_1/3_gen_art/gen_art_experiment_1.md` — 29 prompts
  ...
  - round_2
    ...
    - `3_gen_art/` — 1 task(s)
      - `chat/prompts/2_test_idea/round_2/3_gen_art/gen_art_experiment_1.md` — 18 prompts
...
- **3. report_results** — `gen_paper_repo`
  ...
  - `3_gen_full_paper/` — 2 task(s)
    ...
    - `chat/prompts/3_report_results/3_gen_full_paper/gen_paper_site.md` — 5 prompts
